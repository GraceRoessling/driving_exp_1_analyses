...
var_speed_df <- main_df %>%
  select(subject_id, condition,low_vis_var_speed, high_vis_var_speed) %>%
  gather(key = "visibility", value = "var_speed", low_vis_var_speed, high_vis_var_speed) 
...
var_steering_df <- main_df %>%
  select(subject_id, condition,low_vis_var_steering, high_vis_var_steering) %>%
  gather(key = "visibility", value = "var_steering", low_vis_var_steering, high_vis_var_steering) 
