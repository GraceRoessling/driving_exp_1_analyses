...
# Plot using ggplot
sd_ld_plot_ancova <- ggplot(adj_means_df, aes(x = visibility, y = sd_lane_devs, color = familiarity, group = familiarity)) +
  ...
  labs(
    x = "Visibility",
    y = "SD of Lane Deviation (meters)",
    color = "Track Constancy",
    title = "SD of Lane Deviation for Constant vs. Variable Track Groups"
  ) +
